...
if(isset($_POST['submit'])){
  $title = $_POST['title'];
  $danhmuc = andev($_POST['danhmuc']);
  $editor = $_POST['editor'];
  if (empty($title) || empty($danhmuc) || empty($editor)) {
    $err = 'khong đc de trống';
} else {
    $sql = "INSERT INTO `table_post`(title,content,danhmuc) VALUES ('$title','$editor','$danhmuc')";
      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="../../pages/forms/general.php" class="nav-link active">
